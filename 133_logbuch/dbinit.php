...
if ($result->num_rows == 0 ) {
    ...
    // Die PW-Hashes mit Salt werden mit password_hash
    // nach folgendem Schema erstellt: http://php.net/manual/de/faq.passwords.php#faq.password.storing-salts
...
if ($result->num_rows == 0 ) {
    ...
    $mysqli->query('INSERT INTO post (nachricht, zeitpunkt, autor) VALUES ( "Ja, Gruesse alle Zusammen auch von mir.", "' . date("Y-m-d H:i:s") . '", 2 );' );
