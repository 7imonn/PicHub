...
/***************************************************************************
* VERSION: 3  (jede neue Verteilung wegen Änderungen zählt Version 1 hoch) *
***************************************************************************/

// Erstellt eine  Verbindung zur Datenbank
// AUTOREN: S. Blank, C. Lewe, inf2015.3i
...
// AUTOREN: S. Blank, C. Lewe, inf2015.3i
function insert_new_user($mysqli, $username, $password )
{
	$hash = password_hash($password,PASSWORD_BCRYPT);
	$mysqli->query("INSERT INTO user(name, admin, pw_blowfish) VALUES ('$username', '0' ,'$hash');");
}
